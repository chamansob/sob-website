...
while ($row = mysqli_fetch_array($query)) {  // preparing an array
	...
	$nestedData[] = $ro->course;
	$nestedData[] = '<strong class="text-info">Name:</strong>'.ucfirst($ro->name).'<br><strong class="text-warning">Email:</strong>'.ucfirst($ro->email).'<br><strong class="text-danger">Phone:</strong>'.$ro->phone;
	
	
	$nestedData[] = ucfirst($ro->domain1) . "<br>" . ucfirst($ro->domain2) . "<br>" . ucfirst($ro->domain3);
