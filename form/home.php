                        ...
                        <div class="form">
                            ...
                            <form id="step1" class="login-form" method="post">
								...
								<div class="input-field">                                    
									...
									<select name="country_code" class="custom-wid" required="" style=" margin-bottom:10px;">
...
<option value="Zimbabwe (+263)">Zimbabwe (+263)</option>   </select>
                                ...
                                <div class="input-field delay-100ms">
                                    <input type="text" id="website" name="course" required>
                                    <label>
                                        Enrolled course name with CTA
                                    </label>
                                </div>
                                <div class="input-field delay-100ms">
                                    <input type="url" id="website" name="cdomain1" required>
                                    <label>
                                        Preferred domains 1
                                    </label>
                                </div>
                                <div class="input-field delay-100ms">
                                    <input type="url" id="website" name="cdomain2" required>
                                    <label>
                                        Preferred Domains 2
                                    </label>
                                </div>
                                <div class="input-field delay-100ms">
                                    <input type="url" id="website" name="cdomain3" required>
                                    <label>
                                        Preferred Domains 3
                                    </label>
                                </div>
